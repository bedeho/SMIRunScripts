#!/usr/bin/perl
	...
	# Run values
	my $experiment 						= "fiC0.5-S10-4H-E13-NONE";
	my $stimuliTraining 				= "4H-E13_training"; # simple_testOnFull, simple_training
	my $stimuliTesting 					= "4H-E13_testOnTrained"; # simple_testOnFull, simple_testing
