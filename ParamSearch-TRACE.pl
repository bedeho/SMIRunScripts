#!/usr/bin/perl
	...
	# Run values
	my $experiment 						= "SIMON-TRACE-FANIN1.0-S10-s95-0.5s-4H-E13-NONE";
	...
	my $outputAtTimeStepMultiple		= 10;
    ...
    my @traceTimeConstant				= ("0.400"); #,"0.100","0.500","1.500","2.500"); #("0.100", "0.050", "0.010")
